...
extern void *memset(void *arg_0x7e3a2e90, int arg_0x7e3a0010, size_t arg_0x7e3a01a8);
#line 61
extern void *memset(void *arg_0x7e360d30, int arg_0x7e360e88, size_t arg_0x7e352030);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x7e2b0680);
  ...
  void (**_sig_func)(int arg_0x7e2a0d60);
...
# 10 "../LQTestbedMessages.h"
enum __nesc_unnamed4259 {

  AM_LQT_MSG_TYPE = 0x10, 
  MESSAGES_SUM = 1000, 
...
enum __nesc_unnamed4260 {
  ...
  NODESTAT_MSG_SUBTYPE = 0x02, 

  UP_CONFIG_SUBTYPE = 0x11, 
  UP_CAMMAND_SUBTYPE = 0x12, 


  DOWN_MSG_TYPE = 0x01, 

  DOWN_CONFIG_SUBTYPE = 0x01, 
  DOWN_CAMMAND_SUBTYPE = 0x02, 
  DOWN_ACTIVETEST_SUBTYPE = 0x03
};
#line 54
#line 40
typedef nx_struct LQTMessage {
  ...
  nx_int16_t msgsum;
} __attribute__((packed)) LQTMessage;
#line 78
#line 72
...
typedef TMilli SensorStationC$MsgTimer$precision_tag;
typedef uint16_t SensorStationC$ReadNoiseFloor$val_t;
enum /*HilTimerMilliC.AlarmMilli32C.AlarmFrom.Msp430Timer*/Msp430Timer32khzC$0$__nesc_unnamed4291 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.AlarmC.Msp430Timer*/Msp430Timer32khzC$1$__nesc_unnamed4292 {
...
enum /*CC2420ControlC.Spi*/CC2420SpiC$0$__nesc_unnamed4293 {
  CC2420SpiC$0$CLIENT_ID = 0U
};
enum /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$__nesc_unnamed4294 {
  Msp430Spi0C$0$CLIENT_ID = 0U
};
enum /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$__nesc_unnamed4295 {
  Msp430Usart0C$0$CLIENT_ID = 0U
};
enum /*CC2420ControlC.SyncSpiC*/CC2420SpiC$1$__nesc_unnamed4296 {
  CC2420SpiC$1$CLIENT_ID = 1U
};
enum /*CC2420ControlC.RssiResource*/CC2420SpiC$2$__nesc_unnamed4297 {
...
enum /*CC2420TransmitC.Spi*/CC2420SpiC$3$__nesc_unnamed4298 {
...
static void SensorStationC$CC2420Config$syncDone(error_t error);
# 92 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static void SensorStationC$AMControl$startDone(error_t error);
#line 117
static void SensorStationC$AMControl$stopDone(error_t error);
# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
static void SensorStationC$Boot$booted(void );
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void SensorStationC$AMSend$sendDone(
#line 92
message_t * msg, 
...
SensorStationC$Receive$receive(
#line 60
message_t * msg, 
void * payload, 
...
static void SensorStationC$MsgTimer$fired(void );
# 63 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static void SensorStationC$ReadNoiseFloor$readDone(error_t result, SensorStationC$ReadNoiseFloor$val_t val);
# 34 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430Compare.nc"
...
static error_t CC2420ControlP$ReadRssi$read(void );
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
...
uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
/*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(
#line 85
message_t * msg, 
...
static void SensorStationC$CC2420Config$setChannel(uint8_t channel);
#line 52
static error_t SensorStationC$CC2420Config$sync(void );
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
static error_t SensorStationC$AMControl$start(void );
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static error_t SensorStationC$AMSend$send(am_addr_t addr, 
#line 60
message_t * msg, 
...
SensorStationC$AMSend$getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 56 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static void SensorStationC$CC2420Packet$setPower(message_t *p_msg, uint8_t power);
...
static int8_t SensorStationC$CC2420Packet$getRssi(message_t *p_msg);
...
static uint8_t SensorStationC$CC2420Packet$getLqi(message_t *p_msg);
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
static void SensorStationC$Leds$led0Toggle(void );
#line 72
static void SensorStationC$Leds$led1Toggle(void );
#line 89
static void SensorStationC$Leds$led2Toggle(void );
#line 66
static void SensorStationC$Leds$led1Off(void );
#line 83
static void SensorStationC$Leds$led2Off(void );
#line 45
static void SensorStationC$Leds$led0On(void );
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
static void SensorStationC$MsgTimer$startPeriodic(uint32_t dt);
#line 67
static void SensorStationC$MsgTimer$stop(void );
# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
static error_t SensorStationC$ReadNoiseFloor$read(void );
# 28 "SensorStationC.nc"
bool SensorStationC$busy = FALSE;
message_t SensorStationC$pkt;

int16_t SensorStationC$msgSum = MESSAGES_SUM;
int16_t SensorStationC$sendPeriod = SEND_INTERVAL_MS;
int16_t SensorStationC$msgcounter = 1;
bool SensorStationC$sendingflag = FALSE;
int8_t SensorStationC$nodestate = 0x00;
int8_t SensorStationC$testmode = 0x00;


static inline uint16_t SensorStationC$getRSSI(message_t *msg);
static inline uint16_t SensorStationC$getLQI(message_t *msg);

uint16_t SensorStationC$noiseFloor = 0;

static inline void SensorStationC$Boot$booted(void );
...
static inline void SensorStationC$AMSend$sendDone(message_t *msg, error_t error);
...
static inline void SensorStationC$CC2420Config$syncDone(error_t error);



static inline void SensorStationC$AMControl$startDone(error_t error);
...
static inline void SensorStationC$AMControl$stopDone(error_t error);




static inline void SensorStationC$MsgTimer$fired(void );
#line 114
static inline message_t *SensorStationC$Receive$receive(message_t *msg, void *payload, uint8_t len);
#line 193
static inline uint16_t SensorStationC$getRSSI(message_t *msg);
...
static inline void SensorStationC$ReadNoiseFloor$readDone(error_t error, uint16_t data);
# 30 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430Compare.nc"
...
enum /*CounterMilli32C.Transform*/TransformCounterC$0$__nesc_unnamed4303 {
...
enum /*HilTimerMilliC.AlarmMilli32C.Transform*/TransformAlarmC$0$__nesc_unnamed4304 {
...
enum /*HilTimerMilliC.AlarmToTimerC*/AlarmToTimerC$0$__nesc_unnamed4305 {
#line 63
...
#line 42
enum /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4307 {
...
#line 48
typedef struct /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$__nesc_unnamed4308 {
...
#line 78
static error_t CC2420ControlP$RssiResource$request(void );
# 45 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Strobe.nc"
...
static inline error_t CC2420ControlP$ReadRssi$read(void );
...
enum /*Counter32khz32C.Transform*/TransformCounterC$1$__nesc_unnamed4316 {
...
enum /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC$1$__nesc_unnamed4317 {
...
enum UniqueSendP$__nesc_unnamed4334 {
  UniqueSendP$S_IDLE, 
...
#line 56
struct UniqueReceiveP$__nesc_unnamed4335 {
  am_addr_t source;
  uint8_t dsn;
...
enum UniqueReceiveP$__nesc_unnamed4336 {
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(
#line 92
message_t * msg, 
...
error_t error);
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
static error_t /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(
#line 56
message_t * msg, 
...
/*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(
#line 111
message_t * msg, 
...
static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(
#line 88
message_t * amsg, 
...
am_addr_t addr);
#line 151
static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(
#line 147
message_t * amsg, 
...
static error_t /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(message_t *m, error_t err);
...
static inline void */*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(message_t *m, uint8_t len);
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$fired(uint8_t arg_0x7d8a6dc8){
#line 28
  switch (arg_0x7d8a6dc8) {
#line 28
    case 0:
#line 28
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP$0$Event$default$fired(arg_0x7d8a6dc8);
#line 28
      break;
#line 28
    }
...
#line 98
  __nesc_result = /*AlarmMultiplexC.Alarm.Alarm32khz32C.Transform*/TransformAlarmC$1$Alarm$getNow();
#line 98
...
# 55 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$unconfigure(uint8_t arg_0x7ce4c430){
#line 55
  switch (arg_0x7ce4c430) {
#line 55
...
#line 55
    default:
#line 55
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$unconfigure(arg_0x7ce4c430);
#line 55
      break;
#line 55
    }
...
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$release(uint8_t arg_0x7cfa05f0){
#line 110
  unsigned char __nesc_result;
#line 110

#line 110
  switch (arg_0x7cfa05f0) {
#line 110
...
#line 110
    default:
#line 110
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$release(arg_0x7cfa05f0);
#line 110
      break;
#line 110
    }
...
# 88 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCongestionBackoff(am_id_t arg_0x7d3ef948, message_t * msg){
#line 88
    CC2420ActiveMessageP$RadioBackoff$default$requestCongestionBackoff(arg_0x7d3ef948, msg);
#line 88
}
#line 88
...
# 118 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$isOwner(uint8_t arg_0x7cfa05f0){
#line 118
  unsigned char __nesc_result;
#line 118
...
#line 118
    default:
#line 118
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$isOwner(arg_0x7cfa05f0);
#line 118
      break;
#line 118
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$getConfig(uint8_t arg_0x7cf95068){
#line 39
  union __nesc_unnamed4282 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Msp430SpiConfigure$default$getConfig(arg_0x7cf95068);
#line 39
...
# 49 "/opt/tinyos-2.x/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$configure(uint8_t arg_0x7ce4c430){
#line 49
  switch (arg_0x7ce4c430) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceConfigure$default$configure(arg_0x7ce4c430);
#line 49
      break;
#line 49
    }
...
#line 49
# 209 "/opt/tinyos-2.x/tos/system/ArbiterP.nc"
static inline void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceDefaultOwner$default$immediateRequested(void )
#line 209
{
...
# 51 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$immediateRequested(uint8_t arg_0x7ce4d010){
#line 51
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$immediateRequested(arg_0x7ce4d010);
#line 51
}
#line 51
...
# 87 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$immediateRequest(uint8_t arg_0x7cfa05f0){
#line 87
  unsigned char __nesc_result;
#line 87
...
#line 87
    default:
#line 87
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$immediateRequest(arg_0x7cfa05f0);
#line 87
      break;
#line 87
    }
...
# 43 "/opt/tinyos-2.x/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$requested(uint8_t arg_0x7ce4d010){
#line 43
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$ResourceRequested$default$requested(arg_0x7ce4d010);
#line 43
}
#line 43
...
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$request(uint8_t arg_0x7cfa05f0){
#line 78
  unsigned char __nesc_result;
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$UsartResource$default$request(arg_0x7cfa05f0);
#line 78
      break;
#line 78
    }
...
#line 54
# 55 "SensorStationC.nc"
static inline void SensorStationC$AMSend$sendDone(message_t *msg, error_t error)
{
  if (&SensorStationC$pkt == msg) 
    {
      SensorStationC$busy = FALSE;
    }
}

# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(message_t * msg, error_t error){
#line 99
  SensorStationC$AMSend$sendDone(msg, error);
#line 99
}
#line 99
...
#line 57
{
  /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$sendDone(m, err);
}
...
# 89 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0x7cb2c6b0, message_t * msg, error_t error){
#line 89
  switch (arg_0x7cb2c6b0) {
#line 89
    case 0U:
#line 89
      /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$sendDone(msg, error);
#line 89
      break;
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0x7cb2c6b0, msg, error);
#line 89
      break;
#line 89
    }
...
#line 56
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0x7cb2a0c0, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = CC2420ActiveMessageP$AMSend$send(arg_0x7cb2a0c0, addr, msg, len);
#line 69
...
# 59 "/opt/tinyos-2.x/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP$SendNotifier$aboutToSend(am_id_t arg_0x7d3ef2d0, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP$SendNotifier$default$aboutToSend(arg_0x7d3ef2d0, dest, msg);
#line 59
}
#line 59
...
# 95 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestCca(am_id_t arg_0x7d3ef948, message_t * msg){
#line 95
    CC2420ActiveMessageP$RadioBackoff$default$requestCca(arg_0x7d3ef948, msg);
#line 95
}
#line 95
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420TinyosNetworkP$NonTinyosReceive$receive(uint8_t arg_0x7cb82150, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420TinyosNetworkP$NonTinyosReceive$default$receive(arg_0x7cb82150, msg, payload, len);
#line 67
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Snoop$receive(am_id_t arg_0x7d401880, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = CC2420ActiveMessageP$Snoop$default$receive(arg_0x7d401880, msg, payload, len);
#line 67
...
# 69 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t SensorStationC$AMSend$send(am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$send(addr, msg, len);
#line 69
...
#line 69
# 78 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static error_t CC2420ControlP$RssiResource$request(void ){
#line 78
  unsigned char __nesc_result;
#line 78

#line 78
  __nesc_result = CC2420SpiP$Resource$request(/*CC2420ControlC.RssiResource*/CC2420SpiC$2$CLIENT_ID);
#line 78
...
#line 371
{
  return CC2420ControlP$RssiResource$request();
}

# 55 "/opt/tinyos-2.x/tos/interfaces/Read.nc"
inline static error_t SensorStationC$ReadNoiseFloor$read(void ){
#line 55
  unsigned char __nesc_result;
#line 55

#line 55
  __nesc_result = CC2420ControlP$ReadRssi$read();
#line 55
...
inline static uint8_t SensorStationC$CC2420Packet$getLqi(message_t *p_msg){
#line 72
  unsigned char __nesc_result;
#line 72

#line 72
  __nesc_result = CC2420PacketP$CC2420Packet$getLqi(p_msg);
#line 72
...
#line 72
# 198 "SensorStationC.nc"
static inline uint16_t SensorStationC$getLQI(message_t *msg)
{
  return (uint16_t )SensorStationC$CC2420Packet$getLqi(msg);
}
...
inline static int8_t SensorStationC$CC2420Packet$getRssi(message_t *p_msg){
#line 64
...
#line 64
# 193 "SensorStationC.nc"
static inline uint16_t SensorStationC$getRSSI(message_t *msg)
{
  return (uint16_t )SensorStationC$CC2420Packet$getRssi(msg) - 45;
}
...
inline static void SensorStationC$Leds$led1Toggle(void ){
#line 72
...
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$getPayload(am_id_t arg_0x7cb2a0c0, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = CC2420ActiveMessageP$AMSend$getPayload(arg_0x7cb2a0c0, msg, len);
#line 124
...
# 114 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void * /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(message_t * msg, uint8_t len){
#line 114
  void *__nesc_result;
#line 114
...
#line 65
{
  return /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$getPayload(m, len);
}

# 124 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * SensorStationC$AMSend$getPayload(message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMSend$getPayload(msg, len);
#line 124
...
# 53 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void SensorStationC$MsgTimer$startPeriodic(uint32_t dt){
#line 53
...
inline static void SensorStationC$MsgTimer$stop(void ){
#line 67
...
inline static void SensorStationC$Leds$led2Toggle(void ){
#line 89
  LedsP$Leds$led2Toggle();
#line 89
}
#line 89
# 114 "SensorStationC.nc"
static inline message_t *SensorStationC$Receive$receive(message_t *msg, void *payload, uint8_t len)
{
  ...
  if ((TOS_NODE_ID == __nesc_ntoh_int16(cammandpkt->nodeid.data) || 0xFFFF == __nesc_ntoh_int16(cammandpkt->nodeid.data)) && len == sizeof(LQT_CAMMAND_MSG )) 
    {
      BACK_LQT_CAMMAND_SUSCESS_MSG *backCammandPkt = (BACK_LQT_CAMMAND_SUSCESS_MSG *)SensorStationC$AMSend$getPayload(&SensorStationC$pkt, sizeof(BACK_LQT_CAMMAND_SUSCESS_MSG ));

#line 124
      __nesc_hton_int8(backCammandPkt->msgtype.data, UP_MSG_TYPE);
      __nesc_hton_int8(backCammandPkt->msgsubtype.data, UP_CAMMAND_SUBTYPE);
      __nesc_hton_int16(backCammandPkt->nodeid.data, TOS_NODE_ID);
      SensorStationC$AMSend$send(AM_BROADCAST_ADDR, &SensorStationC$pkt, sizeof(BACK_LQT_CAMMAND_SUSCESS_MSG ));

      SensorStationC$Leds$led2Toggle();
      SensorStationC$nodestate = __nesc_ntoh_int8(cammandpkt->nodestate.data);

      if (SensorStationC$nodestate == 0x00) 
        {
          SensorStationC$sendingflag = FALSE;
        }
      else {
#line 136
        if (SensorStationC$nodestate == 0x01) 
          {
            SensorStationC$sendingflag = TRUE;
          }
        else 
          {
            SensorStationC$sendingflag = TRUE;
            SensorStationC$msgcounter = 1;
          }
        }
    }
  if ((TOS_NODE_ID == __nesc_ntoh_int16(configpkt->nodeid.data) || 0xFFFF == __nesc_ntoh_int16(configpkt->nodeid.data)) && len == sizeof(LQT_CONFIG_MSG )) 
    {

      BACK_LQT_CONFIG_SUSCESS_MSG *backConfigPkt = (BACK_LQT_CONFIG_SUSCESS_MSG *)SensorStationC$AMSend$getPayload(&SensorStationC$pkt, sizeof(BACK_LQT_CONFIG_SUSCESS_MSG ));

#line 151
      __nesc_hton_int8(backConfigPkt->msgtype.data, UP_MSG_TYPE);
      __nesc_hton_int8(backConfigPkt->msgsubtype.data, UP_CONFIG_SUBTYPE);
      __nesc_hton_int16(backConfigPkt->nodeid.data, TOS_NODE_ID);
      SensorStationC$AMSend$send(AM_BROADCAST_ADDR, &SensorStationC$pkt, sizeof(BACK_LQT_CONFIG_SUSCESS_MSG ));

      SensorStationC$Leds$led2Toggle();
      SensorStationC$msgSum = __nesc_ntoh_int16(configpkt->msgsum.data);
      SensorStationC$testmode = __nesc_ntoh_int8(configpkt->testmode.data);
      SensorStationC$sendPeriod = __nesc_ntoh_int16(configpkt->sendperiod.data);
      SensorStationC$MsgTimer$stop();
      if (SensorStationC$testmode == 0x01) 
        {

          SensorStationC$MsgTimer$startPeriodic(SensorStationC$sendPeriod);
        }
    }


  if ((TOS_NODE_ID == __nesc_ntoh_int16(testpkt->nodeid.data) || 0xFFFF == __nesc_ntoh_int16(testpkt->nodeid.data)) && len == sizeof(LQTMessage )) 
    {
      LQTMessage *uptestpkt = (LQTMessage *)SensorStationC$AMSend$getPayload(&SensorStationC$pkt, sizeof(LQTMessage ));

#line 172
      SensorStationC$Leds$led1Toggle();
      __nesc_hton_int8(uptestpkt->msgtype.data, UP_MSG_TYPE);
      __nesc_hton_int8(uptestpkt->msgsubtype.data, LINK_MSG_SUBTYPE);
      __nesc_hton_int16(uptestpkt->nodeid.data, TOS_NODE_ID);
      __nesc_hton_int16(uptestpkt->msgid.data, __nesc_ntoh_int16(testpkt->msgid.data));
      __nesc_hton_int16(uptestpkt->msgsum.data, __nesc_ntoh_int16(testpkt->msgsum.data));

      __nesc_hton_int16(uptestpkt->rssi_down.data, SensorStationC$getRSSI(msg));
      __nesc_hton_int16(uptestpkt->lqi_down.data, SensorStationC$getLQI(msg));
      SensorStationC$ReadNoiseFloor$read();
      __nesc_hton_int16(uptestpkt->snr_down.data, __nesc_ntoh_int16(uptestpkt->rssi_down.data) - SensorStationC$noiseFloor);
      __nesc_hton_int16(uptestpkt->rssi_up.data, 0);
      __nesc_hton_int16(uptestpkt->lqi_up.data, 0);
      __nesc_hton_int16(uptestpkt->snr_up.data, 0);

      SensorStationC$AMSend$send(AM_BROADCAST_ADDR, &SensorStationC$pkt, sizeof(LQTMessage ));
    }
...
# 67 "/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP$Receive$receive(am_id_t arg_0x7d4011e8, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x7d4011e8) {
#line 67
    case 16:
#line 67
      __nesc_result = SensorStationC$Receive$receive(msg, payload, len);
#line 67
      break;
#line 67
    default:
#line 67
      __nesc_result = CC2420ActiveMessageP$Receive$default$receive(arg_0x7d4011e8, msg, payload, len);
#line 67
      break;
#line 67
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/AMPacket.nc"
inline static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(message_t * amsg, am_addr_t addr){
#line 92
...
inline static void /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(message_t * amsg, am_id_t t){
#line 151
...
# 64 "/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static error_t /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(message_t * msg, uint8_t len){
#line 64
  unsigned char __nesc_result;
#line 64
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$granted(uint8_t arg_0x7cfa6820){
#line 92
  switch (arg_0x7cfa6820) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$Resource$default$granted(arg_0x7cfa6820);
#line 92
      break;
#line 92
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$granted(uint8_t arg_0x7ce4e548){
#line 92
  switch (arg_0x7ce4e548) {
#line 92
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 92
...
#line 92
    default:
#line 92
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP$0$Resource$default$granted(arg_0x7ce4e548);
#line 92
      break;
#line 92
    }
...
# 71 "/opt/tinyos-2.x/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$sendDone(uint8_t arg_0x7cfa1dd8, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 71
  switch (arg_0x7cfa1dd8) {
#line 71
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C$0$CLIENT_ID:
#line 71
...
#line 71
    default:
#line 71
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP$0$SpiPacket$default$sendDone(arg_0x7cfa1dd8, txBuf, rxBuf, len, error);
#line 71
      break;
#line 71
    }
...
# 71 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$readDone(uint8_t arg_0x7d080b78, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x7d080b78) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP$Fifo$default$readDone(arg_0x7d080b78, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP$RadioBackoff$requestInitialBackoff(am_id_t arg_0x7d3ef948, message_t * msg){
#line 81
    CC2420ActiveMessageP$RadioBackoff$default$requestInitialBackoff(arg_0x7d3ef948, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP$Fifo$writeDone(uint8_t arg_0x7d080b78, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x7d080b78) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP$Fifo$default$writeDone(arg_0x7d080b78, data, length, error);
#line 91
      break;
#line 91
    }
...
# 92 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
inline static void CC2420SpiP$Resource$granted(uint8_t arg_0x7d080148){
#line 92
  switch (arg_0x7d080148) {
#line 92
...
#line 92
    default:
#line 92
      CC2420SpiP$Resource$default$granted(arg_0x7d080148);
#line 92
      break;
#line 92
    }
...
#line 53
  SensorStationC$CC2420Config$syncDone(error);
#line 53
}
#line 53
...
# 99 "/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP$AMSend$sendDone(am_id_t arg_0x7d409818, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0x7d409818, msg, error);
#line 99
}
#line 99
...
# 56 "/opt/tinyos-2.x/tos/interfaces/Leds.nc"
inline static void SensorStationC$Leds$led0Toggle(void ){
#line 56
  LedsP$Leds$led0Toggle();
#line 56
}
#line 56
# 76 "SensorStationC.nc"
static inline void SensorStationC$AMControl$stopDone(error_t error)
{
  SensorStationC$Leds$led0Toggle();
}

# 117 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static void CC2420CsmaP$SplitControl$stopDone(error_t error){
#line 117
  SensorStationC$AMControl$stopDone(error);
#line 117
}
#line 117
...
inline static error_t SensorStationC$CC2420Config$sync(void ){
#line 52
  unsigned char __nesc_result;
#line 52
...
#line 52
# 275 "/opt/tinyos-2.x/tos/chips/cc2420/control/CC2420ControlP.nc"
static inline void CC2420ControlP$CC2420Config$setChannel(uint8_t channel)
#line 275
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 59 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Config.nc"
inline static void SensorStationC$CC2420Config$setChannel(uint8_t channel){
#line 59
  CC2420ControlP$CC2420Config$setChannel(channel);
#line 59
}
#line 59
# 67 "SensorStationC.nc"
static inline void SensorStationC$AMControl$startDone(error_t error)
{
  if (error == SUCCESS) 
    {
      SensorStationC$CC2420Config$setChannel(CC2420CHANNEL);
      SensorStationC$CC2420Config$sync();
    }
}
...
#line 92
  SensorStationC$AMControl$startDone(error);
#line 92
}
#line 92
# 110 "/opt/tinyos-2.x/tos/interfaces/Resource.nc"
...
# 56 "/opt/tinyos-2.x/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static void SensorStationC$CC2420Packet$setPower(message_t *p_msg, uint8_t power){
#line 56
  CC2420PacketP$CC2420Packet$setPower(p_msg, power);
#line 56
}
#line 56
# 81 "SensorStationC.nc"
static inline void SensorStationC$MsgTimer$fired(void )
{
  if (SensorStationC$msgcounter <= SensorStationC$msgSum && SensorStationC$sendingflag) 
    {
      LQTMessage *tempmsg = (LQTMessage *)SensorStationC$AMSend$getPayload(&SensorStationC$pkt, sizeof(LQTMessage ));

#line 86
      __nesc_hton_int8(tempmsg->msgtype.data, UP_MSG_TYPE);
      __nesc_hton_int8(tempmsg->msgsubtype.data, LINK_MSG_SUBTYPE);
      __nesc_hton_int16(tempmsg->nodeid.data, TOS_NODE_ID);
      __nesc_hton_int16(tempmsg->msgid.data, SensorStationC$msgcounter);
      __nesc_hton_int16(tempmsg->msgsum.data, SensorStationC$msgSum);
      __nesc_hton_int16(tempmsg->rssi_down.data, 0);
      __nesc_hton_int16(tempmsg->lqi_down.data, 0);
      __nesc_hton_int16(tempmsg->rssi_down.data, 0);

      if (!SensorStationC$busy) 
        {
          SensorStationC$CC2420Packet$setPower(&SensorStationC$pkt, CC2420RFPOWER);
          if (SensorStationC$AMSend$send(AM_BROADCAST_ADDR, &SensorStationC$pkt, sizeof(LQTMessage )) == SUCCESS) 
            {
              SensorStationC$busy = TRUE;
              SensorStationC$Leds$led1Toggle();
              if (SensorStationC$msgcounter == SensorStationC$msgSum) 
                {
                  SensorStationC$sendingflag = FALSE;
                }

              SensorStationC$msgcounter++;
            }
        }
    }
}
...
# 72 "/opt/tinyos-2.x/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0x7d488d90){
#line 72
  switch (arg_0x7d488d90) {
#line 72
    case 0U:
#line 72
      SensorStationC$MsgTimer$fired();
#line 72
      break;
#line 72
    default:
#line 72
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0x7d488d90);
#line 72
      break;
#line 72
    }
...
#line 51
  __nesc_result = ecombine(__nesc_result, /*AlarmMultiplexC.Alarm.Alarm32khz32C.AlarmC.Msp430Alarm*/Msp430AlarmC$1$Init$init());
#line 51
...
# 83 "/opt/tinyos-2.x/tos/interfaces/SplitControl.nc"
inline static error_t SensorStationC$AMControl$start(void ){
#line 83
  unsigned char __nesc_result;
#line 83
...
inline static void SensorStationC$Leds$led2Off(void ){
#line 83
  LedsP$Leds$led2Off();
#line 83
}
...
inline static void SensorStationC$Leds$led1Off(void ){
#line 66
  LedsP$Leds$led1Off();
#line 66
}
...
inline static void SensorStationC$Leds$led0On(void ){
#line 45
  LedsP$Leds$led0On();
#line 45
}
#line 45
# 44 "SensorStationC.nc"
static inline void SensorStationC$Boot$booted(void )
{
  SensorStationC$Leds$led0On();
  SensorStationC$Leds$led1Off();
  SensorStationC$Leds$led2Off();

  SensorStationC$AMControl$start();
}

# 49 "/opt/tinyos-2.x/tos/interfaces/Boot.nc"
inline static void RealMainP$Boot$booted(void ){
#line 49
  SensorStationC$Boot$booted();
#line 49
}
#line 49
...
# 54 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$rxDone(uint8_t arg_0x7ce843d0, uint8_t data){
#line 54
  switch (arg_0x7ce843d0) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$rxDone(arg_0x7ce843d0, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.x/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$fired(uint8_t arg_0x7ce84c50){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$I2CInterrupts$default$fired(arg_0x7ce84c50);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$txDone(uint8_t arg_0x7ce843d0){
#line 49
  switch (arg_0x7ce843d0) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C$0$CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP$0$Interrupts$default$txDone(arg_0x7ce843d0);
#line 49
      break;
#line 49
    }
...
# 28 "/opt/tinyos-2.x/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$fired(uint8_t arg_0x7d8a6dc8){
#line 28
  switch (arg_0x7d8a6dc8) {
#line 28
    case 0:
...
#line 28
    default:
#line 28
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP$1$Event$default$fired(arg_0x7d8a6dc8);
#line 28
      break;
#line 28
    }
...
# 622 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$congestionBackoff(void )
#line 622
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 580 "/opt/tinyos-2.x/tos/chips/cc2420/transmit/CC2420TransmitP.nc"
static void CC2420TransmitP$attemptSend(void )
#line 580
{
  uint8_t status;
...
# 64 "/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP$TaskBasic$runTask(uint8_t arg_0x7d9b7580){
#line 64
  switch (arg_0x7d9b7580) {
#line 64
...
#line 64
    default:
#line 64
      SchedulerBasicP$TaskBasic$default$runTask(arg_0x7d9b7580);
#line 64
      break;
#line 64
    }
...
# 158 "/opt/tinyos-2.x/tos/chips/cc2420/csma/CC2420CsmaP.nc"
static void *CC2420CsmaP$Send$getPayload(message_t *m, uint8_t len)
#line 158
{
...
#line 47
{
  /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setDestination(msg, dest);
  /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$AMPacket$setType(msg, 16);
  return /*SensorStationAppC.AMSenderC.AMQueueEntryP*/AMQueueEntryP$0$Send$send(msg, len);
}
