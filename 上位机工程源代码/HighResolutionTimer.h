...
{   
public:
    typedef void (*TIMERCALLBACK)(DWORD); //  ×÷ÓÃTIMERCALLBACK m_pfnCallback; 
...
public:    
    ...
    static void CALLBACK TimeProc(UINT uID,UINT uMsg,DWORD dwUser,DWORD dw1, DWORD dw2)   //User instance data 
    {   
